...
// node_modules/@netlify/emails/dist/index.js
...
var sendEmail = (_a) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  yield fetch(`${process.env.URL}/.netlify/functions/emails/${template}`, {
    headers: {
